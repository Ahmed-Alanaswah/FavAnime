...
if (animeName == 'demon slayer') {
  ...
  for (var i = 0; i < x; i++) {
    document.write('<div>' + '<h3>' + animeName + '</h3>' + '<img style = " width: 100px; height:200px " src="https://www.gematsu.com/wp-content/uploads/2021/06/Demon-Slayer-Kimetsu-no-Yaiba-The-Hinokami-Chronicles_2021_06-20-21_001.jpg" />' + '</div>')
  }
} else if (animeName == 'boku no hero') {
  var x = prompt('how many time u need to see your anime?')
  for (var i = 0; i < x; i++) {
  ...
  alert('sorry u enterd wrong value please try later')
}
>>>>>>> b0a559284a76138c1e6d1317ace095876fbbf711
